       ...
       function validate()
        ...
        <div class="header-block-reg" >
            <div class="left-block">
                    <div class="logotext">WELCOME TO Tours.lk </div>
...
<div class="testbox">
  ...
  <%--  <input type="text" name="usid" id="name" placeholder="uid" required/> --%>
   ...
   <p>By clicking Register, you agree on our <a href="http://localhost:8080/indiatours/termandcondition.jsp">terms and condition</a>.</p>
   <a href="http://localhost:8080/indiatours/home.jsp" class="button" >Home</a>
