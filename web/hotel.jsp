      ...
      Statement  st =  con.createStatement();
       ...
       ResultSet rs = st.executeQuery("select * from travel.hotel ;");%>
        ...
        <%    while(rs.next()){
            ...
            <a href="viewdetail.jsp?hid=<%out.println(id);%>" class="linkbutton">Edit Details</a>&nbsp;&nbsp;&nbsp;&nbsp;
            <a href="viewdetail.jsp?hid=<%out.println(id);%>" class="linkbutton">Remove</a>&nbsp;&nbsp;&nbsp;&nbsp;
            <a href="edit?id=${hotel.hid}">Edit</a>
            </div> 
